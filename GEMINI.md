...
- Load `references/platforms/gemini-cli.md` when Gemini CLI settings, sandboxing, trusted folders, or `context.fileName` behavior matter.
- Keep Gemini-specific instructions thin here and keep shared routing logic in `AGENTS.md` and `SKILL.md`.
